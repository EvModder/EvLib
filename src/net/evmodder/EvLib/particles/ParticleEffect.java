...
public enum ParticleEffect {
	 ...
	 * @param requiredVersion Version which is required (1.x)
	 * @param requiresData Indicates whether additional data is required for this particle effect
	 * @see #ParticleEffect_BROKEN(String, int, boolean, boolean)
	 */
	 ...
	 * @param requiredVersion Version which is required (1.x)
	 * @param requiresData Indicates whether additional data is required for this particle effect
	 * @see #ParticleEffect_BROKEN(String, int, boolean)
	 */
	...
	private static boolean isDataCorrect(ParticleEffect effect, ParticleData data) {
		return ((data.material.isBlock() && (effect == BLOCK_CRACK || effect == BLOCK_DUST)) || effect == ITEM_CRACK);
	}
	/**
	 ...
	 * <p>
	 * This class is part of the <b>ParticleEffect_BROKEN Library</b> and follows the same usage conditions
	 *
	 * @author DarkBlade12
	 * @since 1.6
	 */
	 ...
	 * @since 1.6
	 */
	static final class ParticleDataException extends RuntimeException {
		...
		public void sendTo(Location center, Player player) throws PacketInstantiationException, PacketSendingException {
			if (packet == null) {
				try {
					...
					setField(packet, "b", (float) center.getX());
					setField(packet, "c", (float) center.getY());
					setField(packet, "d", (float) center.getZ());
					...
					setField(packet, "j", longDistance);
					setField(packet, "k", data == null ? new int[0] : data.getPacketData());
				}
				catch(Exception exception) {
